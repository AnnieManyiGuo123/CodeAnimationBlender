...
def partially_clean_the_scene():
    """
    clean the scene by deleting all objects and data
    """
...
def create_noise_mask(material):
    """
    Creates node group within a Blender material's node tree

    Args:
    material (bpy.types.Material): The Blender material whose node tree will be modified.

    rerturns:
    the Color Ramp node at the end of the chain whose output can be connected to other nodes
    """
...
def create_material(name):
    """
    Creates a Blender material with a metallic base and a roughness cover

    Args:
    name (str): The name to assign to the new material

    Returns:
    bpy.types.Material: The newly created material with nodes configured
    """
...
def add_mesh():
    """
    add a smooth-shaded mesh

    returns:
    bpy.types.Object: The active mesh object after creation
    """
